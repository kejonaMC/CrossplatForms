...
public class SpigotPlayer implements FormPlayer {
    ...
    public String getEncodedSkinData() {
        try {
            Object craftPlayer = handle.getClass().getMethod("getHandle").invoke(handle);
            Field profileField = craftPlayer.getClass().getDeclaredField("gameProfile");
            ...
            Logger.get().debug("Failed to get skin data: " + e.getMessage());
        }
        return null;
    }
